...
export default function CambiarPasswordRecuperacion() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.clients.changePasswordAfterRecovery({
        email,
        newPassword,
      });
      ...
      if (response.success && response.data) {
        ...
        // Hacer login automático con los datos retornados
        login({
          userType: "client",
        ...
        setTimeout(() => {
          toast.success("Redirigiendo a tu inicio...");
  ...
  return (
    <PublicRoute>
      <Head>
        ...
        <meta
          name="description"
          content="Cambia tu contraseña después de verificar el código de recuperación"
        />
      </Head>
      <LandingHeader />
